#!/bin/bash
#PBS -l walltime=8:00:00,nodes=1:ppn=24,mem=40gb
...
Rscript ~/projects/sv_nams/scripts/sliding_window_approach_reseq-SNPs.R ${CROSS} ~/projects/sv_nams/analysis/reseq_snps_projection2/NAM_rils_SNPs-reseq_and_SVs-SNPs.${CROSS}.poly.chr-${CHR}.projected.hmp.txt ~/projects/sv_nams/analysis/reseq_snps_projection2/NAM_parents_SNPs-reseq_and_SVs-SNPs.${CROSS}.poly.chr-${CHR}.sorted.hmp.txt --window_size=45 --window_step=1 --min_snps_per_window=15
