...
run_pipeline.pl -Xmx100g -SortGenotypeFilePlugin -inputFile NAM_rils_projected-SNPs-SVs.reseq-snps-all-crosses.chr-${CHR}.projected.hmp.txt -outputFile NAM_rils_projected-SNPs-SVs.reseq-snps-all-crosses.chr-${CHR}.projected.hmp.txt -fileType Hapmap
